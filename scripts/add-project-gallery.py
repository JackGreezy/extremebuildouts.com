...
@media(max-width:980px){
  ...
  header.navigation-top-simple .navbar-container{min-height:68px!important;padding:0 8px 0 18px!important}
  ...
  header.navigation-top-simple .rr-burger{margin-left:auto!important;margin-right:-2px!important;padding-right:0!important}
}
@media(max-width:420px){
  ...
  header.navigation-top-simple .rr-burger{margin-right:-4px!important}
}
</style>
"""
